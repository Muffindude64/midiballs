...
let ctrls = {
    ...
    clr1: {r:90, g:200, b:120}, //color 1
    clr2:{ r:200, g:60, b:85}, //color 2
    d_range: {min: 1, max:15}, //range of sphere diameters
    explode_factor: 0.09, //explode distance
    light_intensity: 2
...
function triggerNote(note) {
    ...
    sphere.position.x = note.number - 25;
    sphere.position.y = Math.ceil(Math.random() * 15) - 7;
    sphere.position.z = Math.ceil(Math.random() * 15) - 7;
    ...
    console.log(clr);
    mat.diffuseColor = new BABYLON.Color3(clr._array[1], clr._array[2], clr._array[3]);
    sphere.material = mat; 
...
let keynotes = [];
keynotes[12] = {name:'C', octave:'4', number:30}
keynotes[89] = {name:'D', octave:'4', number:22}
keynotes[56] = {name:'E', octave:'4', number:89}
keynotes[90] = {name:'F', octave:'4', number:186}
keynotes[48] = {name:'G', octave:'4', number:12}
keynotes[2] = {name:'A', octave:'4', number: 45}
keynotes[46] = {name:'B', octave:'4', number:36}
keynotes[29] = {name:'C', octave:'5', number:90}
